<template>
	<div class="Search container">
		...
		<div class="mb-4 flex flex-col md:flex-row w-3/4 md:w-full max-w-sm md:space-x-3 space-y-3 md:space-y-0 justify-center">
			...
			<button @click="search" class="search flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-teal-600 rounded-lg shadow-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 focus:ring-offset-teal-200" type="submit">
			Search
			</button>
		</div>
		<!-- <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Search Results</h2> -->
		<List>
